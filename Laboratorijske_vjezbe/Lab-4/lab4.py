...
def figMetaData(file_path):
    ...
    webbrowser.open_new_tab(f"http://www.google.com/maps/place/{convertGPScoordinate(img_doc.gps_latitude, img_doc.gps_latitude_ref)}, {convertGPScoordinate(img_doc.gps_longitude, img_doc.gps_longitude_ref)}")
    print(f"{dir(img_doc)}\n")
